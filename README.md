...
<img src="https://img.shields.io/badge/RAG-Pipeline-6A5ACD?style=for-the-badge"/>
...
- 🕸️ **Knowledge Graph** — visual entity and relationship mapping
...
|-----------|-------------|
| 🔍 Semantic Search | Dense vector search across all chunks in a workspace |
| 📌 Page Citations | Every answer references the exact page and document |
| 📂 Multi-doc Queries | Query across multiple uploaded documents at once |
| 🕸️ Knowledge Graph | Extracts entities and relationships from documents |
| 🤝 Team Collaboration | Share workspaces; multiple users, one knowledge base |
| 🧑‍💼 AI Agents | Multi-agent workflows for deep research & summarization |
...
3. **Upload a PDF** — drag & drop or click to browse (digital PDFs only)
